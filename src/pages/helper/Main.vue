...
export default {
  ...
  data() {
    return {
      ...
      deploy: {
        images: [
          require("../../assets/image/deploy0.png"),
          require("../../assets/image/deploy1.png"),
          require("../../assets/image/deploy2.png"),
        ],
        status: "process",
        active: 0,
      },
      use: {
        images: [
          require("../../assets/image/use0.png"),
          require("../../assets/image/use1.png"),
          require("../../assets/image/use2.png"),
        ],
        status: "process",
        active: 0,
      },
