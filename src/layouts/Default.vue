<template>
  <div>
    <section
      class="page-header"
      :style="
        `background-image: linear-gradient(120deg, ${backgroundColorLeft},${backgroundColorRight});color:${fontColor};`
      "
    >
      ...
      <a :href="'https://github.com/' + user.login" class="btn" target="_blank"
        >GitHub主页</a
      >
      <a href="https://github.com/hejie16/vblog" class="btn" target="_blank"
        >博客源码</a
      >
    </section>
    <div
